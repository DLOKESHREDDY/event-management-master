        ...
        <div class="row block-9">
          <div class="col-md-6 pr-md-5">
            <form id="signup_form" onsubmit="return false" class="was-validated">
              ...
              <div class="form-group">
                <input type="text" class="form-control field-border" name="college" placeholder="college-name" required>
              </div>
              <div class="form-group">
                <input type="text" class="form-control field-border" name="branch" placeholder="branch" required>
              </div>
              <div class="form-control field-border" style="border-color:red;">
              <select name="events" >
                <option value="volvo">Events</option>
                <option value="saab">Coding</option>
                <option value="opel">Quiz</option>
