          ...
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block text-center">
              ...
              <div class="media-body p-2 mt-2">
                ...
                <p>Technical coding test is one of the best event that ever conducted till now.</p>
              </div>
            </div>      
          </div>
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block text-center">
              ...
              <div class="media-body p-2 mt-2">
                <h3 class="heading mb-3">Technical event</h3>
                <p>coding test is currently running in room no:32</p>
              </div>
            </div>    
          </div>
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block text-center">
              ...
              <div class="media-body p-2 mt-2">
                <h3 class="heading mb-3">Games</h3>
                <p>Cricket is going to be conducted in few hours please give your teams members names to our dedicated admins.</p>
              </div>
            </div>      
          </div>
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block text-center">
              ...
              <div class="media-body p-2 mt-2">
                <h3 class="heading mb-3">Our Dedicated Admin support</h3>
                <p>We are loved to introduce we are very happy to see you!.</p>
              </div>
            </div>      
          </div>
        </div>
    		...
    		<div class="row">
    			<div class="col-md-12">
    				<div class="single-slider owl-carousel ftco-animate">
	    				...
	    				<div class="item">
		    				<div class="destination">
		    					<a href="#" class="img d-flex justify-content-center align-items-center" style="background-image: url(images/destination-7.jpg);">
                                   ...
                                   <div class='destination'>
                                     ...
                                     <div class='text p-3'>
                                       ...
                                       <p class='bottom-area d-flex'>
                                         <span><i class='icon-map-o'></i> BEC</span> 
    ...
    <section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(images/bg_1.jpg);">
    	<div class="container">
          ...
          <div class="col-md-7 text-center heading-section heading-section-white ftco-animate">
            <h2 class="mb-4">Famous events so far we conducted</h2>
            <span class="subheading">More than 200+ events hosted</span>
          </div>
        </div>
		          ...
		          <div class="col-md-3 d-flex justify-content-center counter-wrap ftco-animate">
		            <div class="block-18 text-center">
		              <div class="text">
		                ...
		                <span>Recent Fest During 2000-2023</span>
		              </div>
		            </div>
		          </div>
		          <div class="col-md-3 d-flex justify-content-center counter-wrap ftco-animate">
      ...
      <div class="container">
        <div class="row justify-content-start">
          <div class="col-md-5 heading-section ftco-animate">
          	<span class="subheading">Event Management</span>
		              ...
		              <div class="item">
		                <div class="testimony-wrap d-flex">
		                  ...
		                  <div class="text ml-md-4">
		                    <p class="mb-5">Dr.K.V.L.N.Acharyulu and N.Ch. Pattabhi Ramacharyulu; On The Stability of An EnemyAmmensal Species Pair with Limited Resources, International Journal of Applied Mathematical
Analysis and Applications, Volume 4, No.2, pp. 149-161, July 2009.</p>
		                    <p class="name">Dr.K.V.L.N ACHARAYALLU</p>
